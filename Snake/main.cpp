...
int main(int argc, char** argv) {
	...
	while(loop == YES)
	{
		...
		switch (dir)
		{
			...
			case RIGHT:verP = verP + 1; if(verP == 24)verP = 1 ;;break;
		...
		if(xf == horP && yf ==verP)
		{
			...
			// difficulty 3: double snake growth
			else
				n = n + 2;
		...
		if(points < 500*(n - 15)/2 && difficulty != 100)
		points++;
